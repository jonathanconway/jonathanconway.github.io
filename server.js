...
app.get('/tech/zero', redirect('https://dev.to/conw_y/towards-zero-bugs-1bop'))
app.get('/tech/three', redirect('https://dev.to/conw_y/three-tests-for-accessibility-1hep'))
